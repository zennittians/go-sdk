...
func (c *Console) initPersonal(vm *goja.Runtime, bridge *bridge) {
	...
	personal.Set("getListAccounts", jsre.MakeCallback(vm, bridge.ItcGetListAccounts))
	personal.Set("signTransaction", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcSignTransaction)))
	personal.Set("sendTransaction", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcSendTransaction)))
	personal.Set("lockAccount", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcLockAccount)))
	personal.Set("importRawKey", jsre.MakeCallback(vm, bridge.ItcImportRawKey))
	personal.Set("unlockAccount", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcUnlockAccount)))
	personal.Set("newAccount", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcNewAccount)))
	personal.Set("sign", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcSign)))
...
func (c *Console) initEth(vm *goja.Runtime, bridge *bridge) {
	...
	eth.Set("sendTransaction", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcSendTransaction)))
	eth.Set("signTransaction", jsre.MakeCallback(vm, bridge.callbackProtected(bridge.ItcSignTransaction)))
}
...
func (c *Console) Welcome() {
	message := "Welcome to the Itc JavaScript console!\n\n"
...
func (b *bridge) ItcGetListAccounts(call jsre.Call) (goja.Value, error) {
	var accounts = []string{}
...
func (b *bridge) ItcSignTransaction(call jsre.Call) (goja.Value, error) {
...
func (b *bridge) ItcSendTransaction(call jsre.Call) (goja.Value, error) {
	txObj := call.Arguments[0].ToObject(call.VM)
	password := ""
...
func (b *bridge) ItcLockAccount(call jsre.Call) (goja.Value, error) {
...
func (b *bridge) ItcImportRawKey(call jsre.Call) (goja.Value, error) {
...
func (b *bridge) ItcUnlockAccount(call jsre.Call) (goja.Value, error) {
...
func (b *bridge) ItcNewAccount(call jsre.Call) (goja.Value, error) {
	return goja.Null(), nil
}

func (b *bridge) ItcSign(call jsre.Call) (goja.Value, error) {
