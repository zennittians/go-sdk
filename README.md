...
See https://docs.intelchain.org/home/network/wallets/intelchain-cli/download-setup for detailed
documentation on how to use the `itc` CLI tools
...
https://github.com/zennittians/intelchain/blob/master/README.md.
